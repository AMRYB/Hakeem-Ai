...
export default function DemoPage() {
  ...
  function handleFrameLoad(event: React.SyntheticEvent<HTMLIFrameElement>) {
    ...
    ensureScript(doc, "/medchat/demo-ocr.js", "hakeem-demo-ocr");
    ...
    ensureStylesheet(doc, "/medchat/voice-mode.css", "hakeem-voice-mode-css");
    ensureStylesheet(doc, "/medchat/demo-ocr.css", "hakeem-demo-ocr-css");
  }
